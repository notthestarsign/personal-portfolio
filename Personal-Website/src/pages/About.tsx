    ...
    <div className="bg-gray-950 text-white min-h-screen w-full">
      ...
      <div className="px-5 py-10 sm:px-10 md:px-20 lg:px-32 flex flex-col md:flex-row items-center justify-center gap-10 md:gap-16 bg-gradient-to-br from-black to-gray-900 rounded-xl shadow-lg mx-4 sm:mx-6 md:mx-10 mt-8 md:mt-12">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          <h2 className="text-2xl mb-3 underline underline-offset-4">
            Background:
          </h2>
            ...
            <ul className="relative border-l border-yellow-400 ml-4 pl-6 space-y-6">
              <li>
                ...
                <h3 className="text-yellow-400 font-semibold">
                  Born in 2003 September 11
                </h3>
                <p>
                  Born and raised in a small town, Parys in the Free State,
                  South Africa.
                </p>
              </li>
              <li>
                ...
                <p>
                  Raised by my mother and grandparents, who instilled in me the
            ...
            <ul className="relative border-l border-yellow-400 ml-4 pl-6 space-y-6">
              <li>
                ...
                <p className="text-gray-300">
                  Began Grade 1 at Schonkenville Intermediate School.
                </p>
              </li>
              <li>
                <span className="absolute -left-2 w-4 h-4 bg-yellow-400 rounded-full"></span>
              ...
              <li>
                ...
                <p className="text-gray-300">
                  I took a gap year to improve my grade 12 results.
                </p>
              </li>
              <li>
                <span className="absolute -left-2 w-4 h-4 bg-yellow-400 rounded-full"></span>
                ...
                <p className="text-gray-300">
                  Enrolled for BSc Computer Science.
                </p>
              </li>
              <li>
                <span className="absolute -left-2 w-4 h-4 bg-yellow-400 rounded-full"></span>
          ...
          <div className="text-gray-300 leading-relaxed">
            <ul className="relative border-l border-yellow-400 ml-4 pl-6 space-y-6">
              <li>
                ...
                <p>
                  I am always on the lookout for new technologies and frameworks
                  to learn. <br />
                  This helps me strengthen my skills and stay updated in the
              ...
              <li>
                ...
                <p>
                  I am passionate about building software that makes life easier
                  and more meaningful for people. <br />
                  Whether it's a small utility or a large application, I love
                  the challenge of solving problems not only through code, but
              ...
              <li>
                ...
                <p>
                  ...
                  Whether it's through open-source contributions, mentoring, or
                  building tools that help others, I strive to make a positive
                  impact and essentially make lives easier.
                </p>
              </li>
              <li>
                <span className="absolute -left-2 w-4 h-4 bg-yellow-400 rounded-full"></span>
                <h3 className="text-yellow-400 font-semibold">
                  Staying humble, curious, and consistent
                </h3>
                <p>
                  I approach every challenge with humility and a willingness to
                  learn. <br />
                  I believe that consistency is key to success, and I strive to
                  improve myself every day, both personally and professionally.{" "}
                  <br />I am always open to feedback and new ideas, and I
                  believe that this mindset will help me grow as a developer and
                  as a person.
                </p>
                <span className="absolute -left-2 w-4 h-4 bg-yellow-400 rounded-full"></span>
              </li>
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center">
            ...
            <ul className="relative border-l border-yellow-400 ml-4 pl-6 space-y-6">
              <li>
                ...
                <p className="text-gray-300">
                  Music has always been a big part of my life. I can say proudly
                  that "I can't live without music." <br />
                  ... <br />
                  I love listening to a wide range of genres, but mostly Hip-Hop
                  as I find it inspiring and motivating. <br />
                  ... <br />
                  I used to be a rapper, but now I just enjoy listening to it.{" "}
                  <br />
                </p>
              </li>
              <li>
              ...
              <li>
                ...
                <p className="text-gray-300">
                  I went into university with no prior programming experience.{" "}
                  <br />
                  ... <br />
                  I only started learning programming in my first year of
                  university, and I have been loving it ever since. <br />
                </p>
              </li>
              <li>
                <span className="absolute -left-2 w-4 h-4 bg-yellow-400 rounded-full"></span>
                ...
                <p className="text-gray-300">
                  I used to be very shy and introverted, but I have worked hard
                  to overcome that. <br />
                  Now I am able to speak in front of large groups of people with
                  confidence, and I am fairly extroverted <br />
                </p>
                <span className="absolute -left-2 w-4 h-4 bg-yellow-400 rounded-full"></span>
              </li>
            </ul>
      ...
      <div className="flex flex-col items-center justify-center p-10 bg-gradient-to-br from-black to-gray-900 mx-10 mt-10 mb-10 rounded-xl">
        ...
        <ul className="relative border-l border-yellow-400 ml-4 pl-6 space-y-6">
          <span className="absolute -left-2 w-4 h-4 bg-yellow-400 rounded-full"></span>
          <li>Motto</li>
          <p className="italic">"Everything happens for a reason"</p>
          <span className="absolute -left-2 w-4 h-4 bg-yellow-400 rounded-full"></span>
          <li className="">Bible Verse:</li>
          <p className="italic">
